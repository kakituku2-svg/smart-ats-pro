const CACHE='settei-kanpa-v4-2-0-light';
const ASSETS=['./','./index.html','./app-v4.2.part1.txt','./app-v4.2.part2.txt','./app-v4.2.part3.txt','./app-v4.2.part4.txt','./app-v4.2.part5.txt','./app-v4.2.part6.txt','./manifest.webmanifest','./icon.svg'];
