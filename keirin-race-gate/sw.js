// KEIRIN RACE GATE — UI v5.8.0 / prediction layers preserved
const CACHE="keirin-race-gate-ui-v5.8.0-r1";
const ASSETS=[
  "./",
  "./index.html",
    ...
    e.respondWith(
      fetch(e.request,{cache:"no-store"})
        ...
        .catch(async()=>{
          ...
          return cached ? injectLayers(cached.clone()) : cached;
        })
    );
    return;
  }
